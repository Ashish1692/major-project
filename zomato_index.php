...
<body>
	...
	<div class="cover">
		<div class="cover-content">
			<h1 id="zom">Zomato</h1>
			<h3 id="head">Restaurants in India</h3>
			<span class="cover-btn">
				<input type="text" name="" placeholder="Search for Dishes and Cuisines..." class="search-box mt-4 mr-0.5"><button class="search-btn mt-3" style="margin-left: 150px;border-radius: 8px;">Browse All</button>
			</span>
		</div>
	</div>
